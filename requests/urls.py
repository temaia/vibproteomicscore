...
# from requests.views import MyView,ProjectInfoGaugeView, TermsOfUseView, AboutView,HomeView, ProjectInfoView, ProjectInfoGuestView,ShippingInstructionsView, ContactView, AboutTheCoreView, AnalysisRegistrationView, InfoView, QuestionsView, PreparationView, AnalysisForm,ExperimentForm,Specimen_SGForm, ContactWizard, ContactWizardSG,ContactWizardPTM,ContactWizardAPMS,ContactWizardGB, LoginView,SGView#,ProjectRegistrationView
# from django.views.generic import TemplateView
